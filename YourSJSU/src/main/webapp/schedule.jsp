    ...
    <div class="portal-shell">
        <aside class="portal-rail" aria-label="Portal navigation">
            ...
            <nav class="portal-nav">
                ...
                <a class="active" href="${pageContext.request.contextPath}/schedule" aria-label="Term Schedule"><span class="nav-icon nav-icon-schedule" aria-hidden="true"></span><span class="nav-label">Term Schedule</span> <span class="nav-badge"><%= enrolledCount %></span></a>
