...
public class EnrollSectionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String error = registrationDAO.enroll(user.getUserId(), sectionId);
        if (error == null) {
            response.sendRedirect(searchRedirect(request, "success", "Enrollment confirmed."));
        } else {
